...
st.write('Als Datenbasis gelten WP-Berichte sowie die im Herbst 2025 publizierte Studie von Urbanistica & Sotomo zum Innenentwicklungspotenzial von Schweizer Gemeinden.')
...
<div id="infoButton" style="position: fixed; top: 40px; left: 10px; z-index: 9999;width: 200px;">
  ...
  <div id="infoBox" style="font-size:10px; display:none; background:white; border:1px solid #888; padding:10px; margin-top:5px;">
...
<div id="infoButton" style="position: fixed; bottom: 10px; left: 10px; z-index: 9999;width: 200px;">
  <button onclick="document.getElementById('sdfd').style.display='block'">
    ℹ️Gewichte
  </button>
  <div id="sdfd" style="font-size:10px; display:none; background:white; border:1px solid #888; padding:10px; margin-top:5px;">
    <b>Informationen</b><br>
